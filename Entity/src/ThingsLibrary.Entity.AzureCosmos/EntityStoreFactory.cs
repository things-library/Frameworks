...
namespace Starlight.Entity.AzureCosmos;
...
/// </remarks>
public class EntityStoreFactory : Interfaces.IEntityStoreFactory
{
    /// <summary>
    ...
    public EntityStoreFactory(string connectionString, string defaultDatabaseName)
    {
