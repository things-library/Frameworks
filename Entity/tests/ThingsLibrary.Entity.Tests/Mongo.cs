...
namespace ThingsLibrary.Entity.Tests
{
    ...
    public class MongoUnitTests
    {
        ...
        [ExpectedException(typeof(ArgumentException))]
        public void Constructor_TestBadEmptyParameters(string connectionString, string tableName)
        {
            var options = new EntityStoreOptions(connectionString, "Test");
        ...
        public void Constructor_TestBadNullParameters(string connectionString, string tableName)
        {
            var options = new EntityStoreOptions(connectionString, "Test");
