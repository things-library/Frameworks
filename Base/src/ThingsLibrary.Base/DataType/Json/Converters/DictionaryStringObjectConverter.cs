// ================================================================================
// <copyright file="DictionaryStringObjectConverter.cs" company="Starlight Software Co">
...
namespace ThingsLibrary.DataType.Json.Converters
{
    public class DictionaryStringObjectConverter : JsonConverter<Dictionary<string, object>>
    {
        ...
        {
            return typeToConvert == typeof(Dictionary<string, object>) || typeToConvert == typeof(Dictionary<string, object?>);
        }
