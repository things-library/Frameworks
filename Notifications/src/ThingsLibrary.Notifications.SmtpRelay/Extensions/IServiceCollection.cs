...
namespace ThingsLibrary.Notification.SmtpRelay.Extensions
{
    public static class IServiceCollectionExtensions
    {
        ...
        public static void AddEmailRelayService(this IServiceCollection services, ItemDto options)// EmailServiceOptions options)
        {            
            // register the singleton
            var emailOptions = new EmailRelayServiceOptions(options);
