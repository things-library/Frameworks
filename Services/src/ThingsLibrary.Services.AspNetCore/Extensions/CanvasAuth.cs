...
namespace ThingsLibrary.Services.AspNetCore.Extensions
{
    ...
    public static class AuthExtensions
    {
        ...
        {
            //{
            //  "authority": "https://thingslibraryusers.ciamlogin.com/thingslibraryusers.onmicrosoft.com/v2.0/?appid=55555555-5555-5555-5555-555555555555",
            //  "domain": "thingslibraryusers.onmicrosoft.com",
            //  "client_id": "55555555-5555-5555-5555-555555555555",
            //  "client_secret": null,
            //  "scopes": "api://55555555-5555-5555-5555-555555555555/default",                                          
            //  "callback_path": "/signin-oidc"
            //}
            //{
            //    "authority": "https://55555555-5555-5555-5555-555555555555.ciamlogin.com/55555555-5555-5555-5555-555555555555/v2.0",
        ...
        {
            // "authority": "https://test.ciamlogin.com/test/v2.0",
            // "issuer": "https://test.ciamlogin.com/test/v2.0",
            // "issuers": "https://sts.windows.net/test/|https://sts.windows.net/test/",
            // "audience": "portal",
            ...
            {
                Log.Information("--- Issuer: {JwtIssuer}", (!string.IsNullOrEmpty(jwtOptions["issuer"]) ? jwtOptions["issuer"] : "<< ANY >>"));
                Log.Information("--- Audience: {JwtAudience}", (!string.IsNullOrEmpty(jwtOptions["audiences"]) ? jwtOptions["audiences"] : "<< ANY >>"));
            }
            else
            {
